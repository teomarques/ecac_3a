        ...
        if RUN_TASK_4_2 or RUN_TASK_4_3_4_4 or RUN_TASK_4_5_4_6:
            ...
            if RUN_TASK_4_3_4_4:
                ...
                if Xp is not None:
                    ...
                    # 4.4.2 Discussão curta
                    print("Vantagens PCA: redução dimensional, remoção de redundâncias, melhora generalização.")
                    print("Limitações PCA: componentes não interpretáveis, assume linearidade, sensível a escala.")
            ...
            if RUN_TASK_4_5_4_6 and X.shape[0] > 0:
                ...
                # 4.6.2 Vantagens e limitações (curto)
                print("\n[4.6.2] Vantagens seleção por filtro (Fisher/ReliefF):")
                print(" - Simples, rápido e escalável; independente do classificador; reduz dimensionalidade e overfitting.")
                print("[4.6.2] Limitações:")
                print(" - Ignora interações entre features; pode não alinhar com a fronteira do classificador; ReliefF depende de métrica de vizinhança.")
